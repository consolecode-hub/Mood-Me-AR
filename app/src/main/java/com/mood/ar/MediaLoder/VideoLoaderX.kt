package com.mood.ar.MediaLoder
...
class VideoLoaderX(var mContext: Context) {
    ...
    val selectionArgs = arrayOf("%MoodVideos%")
        ...
        mJob = CoroutineScope(Dispatchers.IO).launch {
            try {
              ...
              //  val query = mContext.contentResolver.query(collection, mProjection, mSelection, mSelectionArgs, mSortOrder)
                val query = mContext.contentResolver.query(collection, mProjection, selection, selectionArgs, sortOrder)
                ...
                query?.use { cursor ->
                    ...
                    while (cursor.moveToNext()) {
                        ...
                        if (folderName.isEmpty()) folderName = "Documents"
